...
const ProfilePage = () => {
  ...
  const logoutDevice = async () => {
    ...
    try {
      ...
      if (response.data?.success) {
        showNotification("Successfully logged out from: " + (response.data?.loggedOutDevice?.device_name || selectedDeviceId), "success");
  ...
  useEffect(() => {
    async function init() {
      try {
        ...
        showNotification("Something went wrong while fetching devices.", "error");
      }
    }
      ...
      <div className="container border shadow-sm p-md-5 py-md-3">
        ...
        <div className="row my-5">
          <div className="col-md-12 mb-4">
            <div className="card" >
              <div className="card-header py-3">
                <h5 className="mb-0 fw-bold"><i className="bi bi-person-rolodex text-webColor me-2"></i> Personal information</h5>
              </div>
              <ul className="list-group list-group-flush">
                <li className="list-group-item d-flex"><div className="w-50 fw-bold" >Company Name  :</div><div>{user?.company_name}</div> </li>
                <li className="list-group-item d-flex"><div className="w-50 fw-bold" >Nature of Business :</div><div>{user?.nature_business}</div> </li>
                <li className="list-group-item d-flex"><div className="w-50 fw-bold" >Contact Person :</div><div>{user?.name}</div> </li>
                <li className="list-group-item d-flex"><div className="w-50 fw-bold" >Contact Person Designation :</div><div>{user?.contact_person_designation}</div> </li>
                <li className="list-group-item d-flex"><div className="w-50 fw-bold" >Company Address :</div><div>{user?.company_address}</div> </li>
                <li className="list-group-item d-flex"><div className="w-50 fw-bold" >Phone Number :</div><div>+91 {user?.mobile}</div> </li>
              </ul>
            </div>
          </div>
          <div className="col-md-12 mb-4">
            <div className="card" >
              <div className="card-header py-3">
                <h5 className="mb-0 fw-bold"><i className="bi bi-person text-webColor me-2"></i> Account settings</h5>
              </div>
              <ul className="list-group list-group-flush">
                <li className="list-group-item d-flex"><div className="w-50 fw-bold" >Email :</div><div>{user?.email}</div> </li>
                <li className="list-group-item d-flex"><div className="w-50 fw-bold" >Password :</div><button className="btnlink text-webColor" onClick={() => handleShow()}>Change Password</button> </li>
          ...
          <div className="col-md-12 mb-4">
            <div className="card" >
              <div className="card-header py-3">
                <h5 className="mb-0 fw-bold"><i className="bi bi-person-lines-fill text-webColor me-2"></i> Account Activity</h5>
              </div>
          ...
          <div className="col-md-12 mb-4">
            <div className="card" >
              <div className="card-header py-3">
                <h5 className="mb-0 fw-bold"><i className="bi bi-person-lines-fill text-webColor me-2"></i> Devices (LoggedIn)</h5>
              </div>
              <div className="p-3 pb-0">
                ...
                <div className="row justify-content-center align-items-center py-4">
                  ...
                  {devices.map((device) => (
                    <div className="col-md-4 justify-content-center align-items-center text-center d-flex flex-column">
                      ...
                      <button className="pasdatbox px-2 py-1 bg-danger border-0 hover:bg-danger-10" style={{ height: 'auto' }} onClick={() => { handleLogoutClick(device._id) }}>Logout</button>
                    </div>
                  ))}
