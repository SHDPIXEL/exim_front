...
const ExchangeRates = () => {
  ...
  const downloadCSV = () => {
    ...
    let csvContent =
      "Currency,TT Selling Rates,Bill Selling Rates,TT Buying Rates,Bill Buying Rates\n";
  ...
  return (
    <div className="container mt-3">
          ...
          <div className="row ">
            ...
            {exchangeData.length > 0 && (
              <div className="col-md-7  mt-2 justify-content-md-end d-flex  justify-content-center">
                ...
                >
                  <img src={excelicon} width={"50px"} alt="" />
                </button>
                  ...
                  <table className="exchangetable table align-middle mb-0">
                    <thead>
                      <tr>
                        ...
                        <th>
                          <strong>TT SELLING RATES</strong>
                        </th>
                        <th>
                          <strong>BILL SELLING RATES</strong>
                        </th>
                        <th>
                          <strong>TT BUYING RATES</strong>
                        </th>
                        <th>
                          <strong>BILL BUYING RATES</strong>
                        </th>
                      </tr>
                    </thead>
                    <tbody>
                      {exchangeData
                        ...
                        .map((item) => (
                          <tr key={item._id}>
                            ...
                            <td>
                              {item.tt_selling_rates_clean_remittance_outwards}
                            </td>
                            <td>{item.bill_selling_rates_for_imports}</td>
                            <td>
                              {item.tt_buying_rates_clean_remittance_inwards}
                            </td>
      ...
      <BottomAds
        leftPosition={"ExchangeRates_Bottom_Left"}
        rightPosition={"ExchangeRates_Bottom_Right"}
      />
    </div>
  );
};
